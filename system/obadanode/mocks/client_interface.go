...
func (_m *Client) Account(ctx context.Context, address string) (cosmos_sdktypes.AccountI, error) {
	ret := _m.Called(ctx, address)

	var r0 cosmos_sdktypes.AccountI
	if rf, ok := ret.Get(0).(func(context.Context, string) cosmos_sdktypes.AccountI); ok {
		r0 = rf(ctx, address)
	} else {
		if ret.Get(0) != nil {
